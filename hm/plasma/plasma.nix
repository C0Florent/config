...
# Everything below is output from rc2nix
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-53084373-2fd9-4d39-8f1a-f4e9e4d97754" = [ ];
      ...
      "kwin"."Decrease Opacity" = "Meta+Ctrl+Alt+Down,,Decrease Opacity of Active Window by 5%";
      ...
      "kwin"."Increase Opacity" = "Meta+Ctrl+Alt+Up,,Increase Opacity of Active Window by 5%";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,6,27,10,41,3.589";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."53084373-2fd9-4d39-8f1a-f4e9e4d97754" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "53084373-2fd9-4d39-8f1a-f4e9e4d97754";
      ...
      "katerc"."lspclient"."BlockedServerCommandLines" = "/home/fcharpentier/.nix-profile/bin/clangd -log\x3derror --background-index --limit-results\x3d500 --completion-style\x3dbundled";
      ...
      "kcminputrc"."Keyboard"."RepeatDelay" = 180;
      ...
      "kwinrc"."Desktops"."Id_1" = "127269e3-9321-485a-8d07-8d44a95dcacb";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/0ec0820e-100d-5e51-b8c5-4752983b16c6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/5e59686e-4b98-519c-9bed-7db370f157eb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/962ee0c5-5a3e-5a89-a590-89077e4c000d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/a55929f7-d2ad-565d-9eb4-685927c5dd9a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/b70e2e6f-21de-533c-9fc3-4e69e951de65"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.6046296296296294},{\"height\":0.3953703703703706}],\"width\":0.4869791666666668},{\"width\":0.5130208333333333}]}";
      ...
      "kwinrc"."Tiling/d7140545-f7e8-5604-b67f-db6d8b5faa14"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/dc97a2b2-813d-59d4-ab33-724ca4c0a1de"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ea1ca7c0-9ef2-51ea-b207-0a8fd688eda9"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."1"."Description" = "Window settings for mGBA";
      "kwinrulesrc"."1"."above" = true;
      "kwinrulesrc"."1"."aboverule" = 3;
      "kwinrulesrc"."1"."clientmachine" = "localhost";
      "kwinrulesrc"."1"."title" = "mGBA - POKEMON EMER (59.7 fps) - 0.10.3";
      "kwinrulesrc"."1"."types" = 1;
      "kwinrulesrc"."1"."wmclass" = "mgba-qt mGBA";
      "kwinrulesrc"."1"."wmclasscomplete" = true;
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 1;
      "kwinrulesrc"."General"."rules" = 1;
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."Description" = "Window settings for mGBA";
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."above" = true;
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."aboverule" = 3;
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."clientmachine" = "localhost";
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."title" = "mGBA - POKEMON EMER (59.7 fps) - 0.10.3";
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."types" = 1;
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."wmclass" = "mgba-qt mGBA";
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."wmclasscomplete" = true;
      "kwinrulesrc"."dbee903a-f050-40ed-adf4-c41880aa47ab"."wmclassmatch" = 1;
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."Description" = "Window settings for mGBA";
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."clientmachine" = "localhost";
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."title" = "mGBA - POKEMON EMER (59.5 fps) - 0.10.3";
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."types" = 1;
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."wmclass" = "mgba-qt mGBA";
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."wmclasscomplete" = true;
      "kwinrulesrc"."e554d28f-e32a-40d5-9d80-111b170bbdac"."wmclassmatch" = 1;
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/fcharpentier/Pictures/image.png";
      ...
      "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/fcharpentier/Epitech/tek3/survivor_pool/Screenshot_20240907_144409.png";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/fcharpentier/Epitech/tek3/survivor_pool/Screenshot_20240907_144409.png";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/fcharpentier/Downloads/banned_functions(1).note";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1628;
